        ...
        return(
            <div>
                <header>
                    ...
                    <form action="" method ="POST" style={{marginLeft:"20%",marginRight:"20%",textAlign:"justify",padding:"2% 3%",fontSize:"20px",backgroundColor:"skyblue",borderRadius:"15px"}}>
                        ...
                        <b style={{width:"20%"}}>Password </b><input type = "password"  name="password" placeholder = "Enter your password" style={{padding:"1%",width:"80%",borderRadius:"5px", marginLeft:"3.3%"}} required/><br/><br/>
                    ...
                    <form action="" method ="POST" style={{marginLeft:"20%",marginRight:"20%",marginBottom:"5%",textAlign:"justify",padding:"2% 3%",fontSize:"20px",backgroundColor:"skyblue",borderRadius:"15px"}}>
                        ...
                        <select name="category" style={{padding:"1%",width:"50%",borderRadius:"5px", marginLeft:"3.5%"}} required>
